...
//Verticale muren voor gang aangegeven met kruisjes
...
//Horizontale muren voor gang aangegeven met cirkels
...
//Verticale muren voor gang aangegeven met cirkels
...
//Horizontale muren voor gang aangegeven met vierkantjes
...
//Verticale muren voor gang aangegeven met vierkantjes
...
//De textures voor de muren worden ingeladen
...
//De muren worden aangemaakt en krijgen een texture 
...
var rightdoor = new THREE.MeshPhongMaterial({
	side: THREE.DoubleSide,
...
for (i = horizontal.length; i < vertical.length + horizontal.length; i++) {
	...
	function loadObjects() {
		//Alle modellen voor de nutteloze objecten worden ingeladen
