 ...
 * NO niet verwijderen/kan handig zijn als we een ui willen maken
 */
  function gui() {
...
function init() {
    ...
    // Load Textures
// Current textures [floors][walls][ceilings][gate]
    textures.push(loader.load('textures/temple/Tileable10.png'));
    textures.push(loader.load('textures/torture/Tileable9t.png'));
    textures.push(loader.load('textures/torture/Tileable10t.png'));
    textures.push(loader.load('textures/cave/Tilable1d.png'));
